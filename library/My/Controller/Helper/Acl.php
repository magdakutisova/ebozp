...
class My_Controller_Helper_Acl extends Zend_Acl{
	...
	public function __construct(){
		...
		$this->allow($technician, "audit:mistake", array("attach", "auditlist", "edit.html", "get", "delete", "createalone1", "createalone2", "postalone", "edit", "checkedit", "delete.html", "delete", "put.html"));
		...
		$this->allow($technician, "audit:check", array("index", "create", "post", "edit", "put", "techsubmit", "action", "get"));
		...
		$this->allow($coordinator, "audit:check", array("get", "review", "coordsubmit"));
		$this->deny($coordinator, "audit:check", array("techsubmit", "post", "create", "edit"));
